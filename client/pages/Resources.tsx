...
const domainResources: Record<string, { title: string; url: string }[]> = {
  "Data Science": [
    { title: "Hands-On ML with Scikit-Learn & TF", url: "https://www.oreilly.com/library/view/hands-on-machine-learning/9781492032632/" },
...
const generalCoding = [
  { title: "C Programming Language (K&R)", url: "https://en.wikipedia.org/wiki/The_C_Programming_Language" },
    ...
    <section className="container py-12">
      <div className="mx-auto max-w-4xl space-y-6">
        <div className="text-center">
          <h1 className="text-3xl font-extrabold tracking-tight">Learning Resources</h1>
          <p className="text-muted-foreground">Curated content and a roadmap based on your chosen career path.</p>
        </div>
        ...
        {topDomain && items ? (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Start here to build strong foundations.</CardDescription>
            </CardHeader>
            <CardContent>
              <ol className="space-y-2">
                {items.map((r, i) => (
                  <li key={r.url} className="flex items-start gap-2">
                    <span className="mt-0.5 inline-flex h-5 w-5 items-center justify-center rounded-full bg-primary/10 text-xs font-bold text-primary">{i + 1}</span>
                    <a className="underline underline-offset-4" href={r.url} target="_blank" rel="noreferrer">{r.title}</a>
                  </li>
                ))}
              </ol>
            </CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>We need your target domain to personalize resources.</CardDescription>
            </CardHeader>
            <CardContent>
              <Button asChild>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Explore languages and core CS skills</CardDescription>
          </CardHeader>
          <CardContent>
